...
class IconButton(Button):
    ...
    icon_font_size_sp = NumericProperty(sp(16))
    ...
    def __init__(self, **kwargs):
        ...
        self.bind(
            icon_text=self._update_text_and_font,
            icon_font_size_sp=self._update_text_and_font,
            icon_font_name=self.setter('font_name'),
        ...
        Clock.schedule_once(self.draw_custom_graphics, 0.01)
